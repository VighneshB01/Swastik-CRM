...
Swastik CRM is a full-featured CRM built with React, shadcn-admin-kit, and Supabase. It provides contact management, task tracking, notes, email capture, and deal management with a Kanban board.
...
│   ├── swastik-crm/        # Main CRM application code (~15,000 LOC)
...
- The codebase is intentionally small (~15,000 LOC in `src/components/swastik-crm`) for easy customization
